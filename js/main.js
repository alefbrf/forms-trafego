...
(function(){
      emailjs.init("GQuihrdTb38gZH7K9");
})();
...
let redeSocial = document.getElementById("rede-social").value;
let oQue =  document.getElementById("oQue").value;
let modelo = document.getElementById("modelo").value;
let diferencial = document.getElementById("diferencial").value;
...
let promessa = document.getElementById("promessa").value;
let valor = document.getElementById("valor").value;
    ...
    emailjs.send("service_2o66cfg","template_7384af3", templateParams)
